...
#
# Rung   : iq2_m  (Qwen3-8B IQ2_M)
# Quant  : IQ2_M  (iquant, ~2.98 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-IQ2_M.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-IQ2_M.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
