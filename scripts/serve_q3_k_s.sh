...
#
# Rung   : q3_k_s  (Qwen3-8B Q3_K_S)
# Quant  : Q3_K_S  (kquant, ~3.68 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q3_K_S.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q3_K_S.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
