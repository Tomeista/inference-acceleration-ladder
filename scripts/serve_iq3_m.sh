...
#
# Rung   : iq3_m  (Qwen3-8B IQ3_M)
# Quant  : IQ3_M  (iquant, ~3.81 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-IQ3_M.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-IQ3_M.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
