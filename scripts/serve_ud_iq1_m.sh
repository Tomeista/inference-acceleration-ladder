...
#
# Rung   : ud_iq1_m  (Qwen3-8B UD-IQ1_M (Unsloth dynamic))
# Quant  : UD-IQ1_M  (iquant, ~2.34 bpw nominal)
# Source : unsloth/Qwen3-8B-GGUF :: Qwen3-8B-UD-IQ1_M.gguf
...
llama-server \
    --model models/gguf/Qwen3-8B-UD-IQ1_M.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
