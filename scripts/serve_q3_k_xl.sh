...
#
# Rung   : q3_k_xl  (Qwen3-8B Q3_K_XL)
# Quant  : Q3_K_XL  (kquant, ~4.86 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q3_K_XL.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q3_K_XL.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
