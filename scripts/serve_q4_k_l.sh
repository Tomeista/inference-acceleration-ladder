...
#
# Rung   : q4_k_l  (Qwen3-8B Q4_K_L)
# Quant  : Q4_K_L  (kquant, ~5.36 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q4_K_L.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q4_K_L.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
