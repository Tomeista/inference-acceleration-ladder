...
#
# Rung   : q3_k_m  (Qwen3-8B Q3_K_M)
# Quant  : Q3_K_M  (kquant, ~4.03 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q3_K_M.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q3_K_M.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
