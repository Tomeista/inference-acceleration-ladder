...
#
# Rung   : iq2_xxs  (Qwen3-8B IQ2_XXS)
# Quant  : IQ2_XXS  (iquant, ~2.06 bpw nominal)
# Source : bartowski/Qwen3-8B-GGUF :: Qwen3-8B-IQ2_XXS.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen3-8B-IQ2_XXS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
