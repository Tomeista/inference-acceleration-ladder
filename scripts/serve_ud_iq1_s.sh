...
#
# Rung   : ud_iq1_s  (Qwen3-8B UD-IQ1_S (Unsloth dynamic))
# Quant  : UD-IQ1_S  (iquant, ~2.22 bpw nominal)
# Source : unsloth/Qwen3-8B-GGUF :: Qwen3-8B-UD-IQ1_S.gguf
...
llama-server \
    --model models/gguf/Qwen3-8B-UD-IQ1_S.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
