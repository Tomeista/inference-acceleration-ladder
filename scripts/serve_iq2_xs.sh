...
#
# Rung   : iq2_xs  (Qwen3-8B IQ2_XS)
# Quant  : IQ2_XS  (iquant, ~2.31 bpw nominal)
# Source : bartowski/Qwen3-8B-GGUF :: Qwen3-8B-IQ2_XS.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen3-8B-IQ2_XS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
