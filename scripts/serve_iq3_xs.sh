...
#
# Rung   : iq3_xs  (Qwen3-8B IQ3_XS)
# Quant  : IQ3_XS  (iquant, ~3.54 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-IQ3_XS.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-IQ3_XS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
