...
#
# Rung   : q6_k_l  (Qwen3-8B Q6_K_L)
# Quant  : Q6_K_L  (kquant, ~6.86 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q6_K_L.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q6_K_L.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
