...
#
# Rung   : iq3_xxs  (Qwen3-8B IQ3_XXS)
# Quant  : IQ3_XXS  (iquant, ~3.29 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-IQ3_XXS.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-IQ3_XXS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
