...
#
# Rung   : ud_iq3_xxs  (Qwen3-8B UD-IQ3_XXS (Unsloth dynamic))
# Quant  : UD-IQ3_XXS  (iquant, ~3.33 bpw nominal)
# Source : unsloth/Qwen3-8B-GGUF :: Qwen3-8B-UD-IQ3_XXS.gguf
...
llama-server \
    --model models/gguf/Qwen3-8B-UD-IQ3_XXS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
