...
#
# Rung   : q6_k  (Qwen3-8B Q6_K)
# Quant  : Q6_K  (kquant, ~6.57 bpw nominal)
# Source : bartowski/Qwen_Qwen3-8B-GGUF :: Qwen_Qwen3-8B-Q6_K.gguf
# Group  : ladder
#
...
llama-server \
    --model models/gguf/Qwen_Qwen3-8B-Q6_K.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
