...
#
# Rung   : ud_iq2_xxs  (Qwen3-8B UD-IQ2_XXS (Unsloth dynamic))
# Quant  : UD-IQ2_XXS  (iquant, ~2.54 bpw nominal)
# Source : unsloth/Qwen3-8B-GGUF :: Qwen3-8B-UD-IQ2_XXS.gguf
# Group  : sub3_extension
#
...
llama-server \
    --model models/gguf/Qwen3-8B-UD-IQ2_XXS.gguf \
    --alias qwen3-8b \
    --host 127.0.0.1 \
    --port 8080 \
    --n-gpu-layers 99 \
